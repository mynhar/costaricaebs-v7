document.addEventListener("DOMContentLoaded", function () {
  ...
  const industryData = {
    "Banking & Finance": {
      ...
      description:
        "Secure, compliant IT infrastructure for financial institutions with high availability requirements.",
      solutions: [
    ...
    Manufacturing: {
      ...
      description:
        "Industrial-grade IT infrastructure for manufacturing operations with uptime-critical systems.",
      solutions: [
    ...
    Healthcare: {
      ...
      description:
        "HIPAA-compliant infrastructure for healthcare providers with patient data protection.",
      solutions: [
    ...
    Energy: {
      ...
      description:
        "Mission-critical infrastructure for energy providers with unique operational requirements.",
      solutions: [
    ...
    Retail: {
      ...
      description:
        "Scalable infrastructure for retail operations with high transaction volumes.",
      solutions: [
